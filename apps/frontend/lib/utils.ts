...
export const PAYMENT_CONTRACT_ADDRESS = process.env
  .NEXT_PUBLIC_PAYMENT_CONTRACT_ADDRESS as string;

export const HUB_URL = process.env.NEXT_PUBLIC_HUB_URL || "ws://localhost:8080";
export const PROXY_URL = process.env.NEXT_PUBLIC_PROXY_URL || "/api/proxy"; // Use Next.js API route as proxy
