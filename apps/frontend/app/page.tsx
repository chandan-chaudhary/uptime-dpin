        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <Card className="relative border-slate-800 bg-slate-900/50 overflow-hidden shadow-lg">
                <CardHeader className="bg-slate-900/80 border-b border-slate-800 text-slate-100">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="relative h-48 bg-slate-950/50 rounded-lg p-4 border border-slate-800">
                      {/* Y-axis labels */}
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-900/50">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="border-slate-800 bg-slate-900/50 hover:border-emerald-500/50 transition-all hover:shadow-lg hover:shadow-emerald-500/10">
            ...
            <Card className="border-slate-800 bg-slate-900/50 hover:border-blue-500/50 transition-all hover:shadow-lg hover:shadow-blue-500/10">
              <CardContent className="pt-6">
                <div className="flex items-center gap-4 mb-4">
            ...
            <Card className="border-slate-800 bg-slate-900/50 hover:border-orange-500/50 transition-all hover:shadow-lg hover:shadow-orange-500/10">
              <CardContent className="pt-6">
                <div className="flex items-center gap-4 mb-4">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-emerald-600 to-emerald-700">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-emerald-100 mb-8">
            Join thousands of businesses that trust us to keep their websites
            online
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              size="lg"
              variant="secondary"
              className="text-base bg-white text-emerald-600 hover:bg-slate-100"
            >
              Start Free Trial
            </Button>
            <Button
